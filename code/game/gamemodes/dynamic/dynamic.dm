...
/datum/game_mode/dynamic/admin_panel()
	...
	dat += "Current threat: <b>[threat]</b> <a href='byond://?src=\ref[src];[HrefToken()];adjustthreat=1'>\[Adjust\]</A> <a href='byond://?src=\ref[src];[HrefToken()];threatlog=1'>\[View Log\]</a><br/>"
	dat += "<br/>"
	dat += "Storyteller: <a href='byond://?src=\ref[src];[HrefToken()];change_storyteller=1'><b>[storyteller.name]</b></a> <br/>"
