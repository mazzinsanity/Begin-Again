...
/obj/machinery/rnd/experimentor/ui_interact(mob/user)
	...
	if(!linked_console)
		dat += "<b><a href='byond://byond://?src=[REF(src)];function=search'>Scan for R&D Console</A></b>"
	if(loaded_item)
		dat += "<b>Loaded Item:</b> [loaded_item]"

		dat += "<div>Available tests:"
		dat += "<b><a href='byond://byond://?src=[REF(src)];item=[REF(loaded_item)];function=[SCANTYPE_POKE]'>Poke</A></b>"
		dat += "<b><a href='byond://byond://?src=[REF(src)];item=[REF(loaded_item)];function=[SCANTYPE_IRRADIATE];'>Irradiate</A></b>"
		dat += "<b><a href='byond://byond://?src=[REF(src)];item=[REF(loaded_item)];function=[SCANTYPE_GAS]'>Gas</A></b>"
		dat += "<b><a href='byond://byond://?src=[REF(src)];item=[REF(loaded_item)];function=[SCANTYPE_HEAT]'>Burn</A></b>"
		dat += "<b><a href='byond://byond://?src=[REF(src)];item=[REF(loaded_item)];function=[SCANTYPE_COLD]'>Freeze</A></b>"
		dat += "<b><a href='byond://byond://?src=[REF(src)];item=[REF(loaded_item)];function=[SCANTYPE_OBLITERATE]'>Destroy</A></b></div>"
		if(istype(loaded_item,/obj/item/relic))
			dat += "<b><a href='byond://byond://?src=[REF(src)];item=[REF(loaded_item)];function=[SCANTYPE_DISCOVER]'>Discover</A></b>"
		dat += "<b><a href='byond://byond://?src=[REF(src)];function=eject'>Eject</A>"
	...
	dat += "<a href='byond://byond://?src=[REF(src)];function=refresh'>Refresh</A>"
	dat += "<a href='byond://byond://?src=[REF(src)];close=1'>Close</A></center>"
	...
	if(exp == SCANTYPE_GAS)
		...
		if(prob(EFFECT_PROB_LOW) && criticalReaction)
			...
			chosenchem = pick(/datum/reagent/carbon,/datum/reagent/radium,/datum/reagent/toxin,
							...
							/datum/reagent/drug/space_drugs,/datum/reagent/consumable/ethanol)
