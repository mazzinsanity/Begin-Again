...
/obj/machinery/icecream_vat/ui_interact(mob/user)
	...
	dat += "<b>Peach ice cream:</b> <a href='byond://?src=[REF(src)];select=[ICECREAM_PEACH]'><b>Select</b></a> <a href='byond://?src=[REF(src)];make=[ICECREAM_PEACH];amount=1'><b>Make</b></a> <a href='byond://?src=[REF(src)];make=[ICECREAM_PEACH];amount=5'><b>x5</b></a> [product_types[ICECREAM_PEACH]] dollops left. (Ingredients: milk, ice, peach juice)<br>"
	dat += "<b>Grape ice cream:</b> <a href='byond://?src=[REF(src)];select=[ICECREAM_GRAPE]'><b>Select</b></a> <a href='byond://?src=[REF(src)];make=[ICECREAM_GRAPE];amount=1'><b>Make</b></a> <a href='byond://?src=[REF(src)];make=[ICECREAM_GRAPE];amount=5'><b>x5</b></a> [product_types[ICECREAM_GRAPE]] dollops left. (Ingredients: milk, ice, grape juice)<br>"
