...
<th>Mental Status</th>
				...
				if(4)
					...
					if(active2 in GLOB.data_core.medical)
						...
						dat += "<tr><td><br>Allergies:</td><td><br><A href='byond://?src=[REF(src)];field=alg'>&nbsp;[active2.fields["alg"]]&nbsp;</A></td></tr>"
						dat += "<tr><td>Details:</td><td><A href='byond://?src=[REF(src)];field=alg_d'>&nbsp;[active2.fields["alg_d"]]&nbsp;</A></td></tr>"
