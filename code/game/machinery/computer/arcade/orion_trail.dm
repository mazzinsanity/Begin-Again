...
/obj/machinery/computer/arcade/orion_trail/ui_interact(mob/user)
	...
	if(gameStatus == ORION_STATUS_GAMEOVER)
		...
		dat += "<P ALIGN=Right><a href='byond://byond://?src=[REF(src)];menu=1'>May They Rest In Peace</a></P>"
	else if(event)
		dat = eventdat
		...
		if(turns == 7)
			dat += "<P ALIGN=Right><a href='byond://byond://?src=[REF(src)];pastblack=1'>Go Around</a> <a href='byond://byond://?src=[REF(src)];blackhole=1'>Continue</a></P>"
		else
			dat += "<P ALIGN=Right><a href='byond://byond://?src=[REF(src)];continue=1'>Continue</a></P>"
		dat += "<P ALIGN=Right><a href='byond://byond://?src=[REF(src)];killcrew=1'>Kill a Crewmember</a></P>"
		dat += "<P ALIGN=Right><a href='byond://byond://?src=[REF(src)];close=1'>Close</a></P>"
	else
		dat = "<center><h2>The Orion Trail</h2></center>"
		dat += "<br><center><h3>Experience the journey of your ancestors!</h3></center><br><br>"
		dat += "<center><b><a href='byond://byond://?src=[REF(src)];newgame=1'>New Game</a></b></center>"
		dat += "<P ALIGN=Right><a href='byond://byond://?src=[REF(src)];close=1'>Close</a></P>"
...
/obj/machinery/computer/arcade/orion_trail/proc/event()
	...
	switch(event)
		if(ORION_TRAIL_RAIDERS)
			...
			eventdat += "<P ALIGN=Right><a href='byond://byond://?src=[REF(src)];eventclose=1'>Continue</a></P>"
			eventdat += "<P ALIGN=Right><a href='byond://byond://?src=[REF(src)];close=1'>Close</a></P>"
			canContinueEvent = 1
		...
		if(ORION_TRAIL_FLUX)
			...
			eventdat += "<P ALIGN=Right><a href='byond://byond://?src=[REF(src)];slow=1'>Slow Down</a> <a href='byond://byond://?src=[REF(src)];keepspeed=1'>Continue</a></P>"
			eventdat += "<P ALIGN=Right><a href='byond://byond://?src=[REF(src)];close=1'>Close</a></P>"
		...
		if(ORION_TRAIL_BREAKDOWN)
			...
			if(engine >= 1)
				eventdat += "<P ALIGN=Right><a href='byond://byond://?src=[REF(src)];useengine=1'>Use Part</a><a href='byond://byond://?src=[REF(src)];wait=1'>Wait</a></P>"
			else
				eventdat += "<P ALIGN=Right><a href='byond://byond://?src=[REF(src)];wait=1'>Wait</a></P>"
			eventdat += "<P ALIGN=Right><a href='byond://byond://?src=[REF(src)];close=1'>Close</a></P>"
		...
		if(ORION_TRAIL_MALFUNCTION)
			...
			if(electronics >= 1)
				eventdat += "<P ALIGN=Right><a href='byond://byond://?src=[REF(src)];useelec=1'>Use Part</a><a href='byond://byond://?src=[REF(src)];wait=1'>Wait</a></P>"
			else
				eventdat += "<P ALIGN=Right><a href='byond://byond://?src=[REF(src)];wait=1'>Wait</a></P>"
			eventdat += "<P ALIGN=Right><a href='byond://byond://?src=[REF(src)];close=1'>Close</a></P>"
		...
		if(ORION_TRAIL_COLLISION)
			...
			if(hull >= 1)
				eventdat += "<P ALIGN=Right><a href='byond://byond://?src=[REF(src)];usehull=1'>Use Part</a><a href='byond://byond://?src=[REF(src)];wait=1'>Wait</a></P>"
			else
				eventdat += "<P ALIGN=Right><a href='byond://byond://?src=[REF(src)];wait=1'>Wait</a></P>"
			eventdat += "<P ALIGN=Right><a href='byond://byond://?src=[REF(src)];close=1'>Close</a></P>"
		...
		if(ORION_TRAIL_BLACKHOLE)
			...
			eventdat += "<P ALIGN=Right><a href='byond://byond://?src=[REF(src)];holedeath=1'>Oh...</a></P>"
			eventdat += "<P ALIGN=Right><a href='byond://byond://?src=[REF(src)];close=1'>Close</a></P>"
			settlers = list()
		...
		if(ORION_TRAIL_LING)
			...
			if(settlers.len <= 2)
				...
				eventdat += "<P ALIGN=Right><a href='byond://byond://?src=[REF(src)];killcrew=1'>Kill a Crewmember</a></P>"
				eventdat += "<P ALIGN=Right><a href='byond://byond://?src=[REF(src)];eventclose=1'>Risk it</a></P>"
				eventdat += "<P ALIGN=Right><a href='byond://byond://?src=[REF(src)];close=1'>Close</a></P>"
			canContinueEvent = 1
		...
		if(ORION_TRAIL_SPACEPORT)
			...
			if(spaceport_raided)
				...
				eventdat += "<P ALIGN=Right><a href='byond://byond://?src=[REF(src)];leave_spaceport=1'>Depart Spaceport</a></P>"
				eventdat += "<P ALIGN=Right><a href='byond://byond://?src=[REF(src)];close=1'>Close</a></P>"
			else
				...
				//Buy crew
				if(food >= 10 && fuel >= 10)
					eventdat += "<P ALIGN=Right><a href='byond://byond://?src=[REF(src)];buycrew=1'>Hire a New Crewmember (-10FU, -10FO)</a></P>"
				else
					eventdat += "<P ALIGN=Right>You cannot afford a new crewmember.</P>"

				//Sell crew
				if(settlers.len > 1)
					eventdat += "<P ALIGN=Right><a href='byond://byond://?src=[REF(src)];sellcrew=1'>Sell Crew for Fuel and Food (+7FU, +7FO)</a></P>"
				else
				...
				//Engine parts
				if(fuel > 5)
					eventdat += "<P ALIGN=Right><a href='byond://byond://?src=[REF(src)];buyparts=1'>Buy Engine Parts (-5FU)</a></P>"
				else
					eventdat += "<P ALIGN=Right>You cannot afford engine parts.</a>"

				//Hull plates
				if(fuel > 5)
					eventdat += "<P ALIGN=Right><a href='byond://byond://?src=[REF(src)];buyparts=2'>Buy Hull Plates (-5FU)</a></P>"
				else
					eventdat += "<P ALIGN=Right>You cannot afford hull plates.</a>"

				//Electronics
				if(fuel > 5)
					eventdat += "<P ALIGN=Right><a href='byond://byond://?src=[REF(src)];buyparts=3'>Buy Spare Electronics (-5FU)</a></P>"
				else
					eventdat += "<P ALIGN=Right>You cannot afford spare electronics.</a>"

				//Trade
				if(fuel > 5)
					eventdat += "<P ALIGN=Right><a href='byond://byond://?src=[REF(src)];trade=1'>Trade Fuel for Food (-5FU,+5FO)</a></P>"
				else
					eventdat += "<P ALIGN=Right>You don't have 5FU to trade.</P"

				if(food > 5)
					eventdat += "<P ALIGN=Right><a href='byond://byond://?src=[REF(src)];trade=2'>Trade Food for Fuel (+5FU,-5FO)</a></P>"
				else
					eventdat += "<P ALIGN=Right>You don't have 5FO to trade.</P"

				//Raid the spaceport
				eventdat += "<P ALIGN=Right><a href='byond://byond://?src=[REF(src)];raid_spaceport=1'>!! Raid Spaceport !!</a></P>"
