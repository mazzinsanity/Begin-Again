...
/obj/machinery/computer/pod/ui_interact(mob/user)
	...
	if(connected)
		...
		dat += "<HR>\nTimer System: [d2]\nTime Left: [DisplayTimeText(time)] <A href='byond://?src=[REF(src)];tp=-30'>-</A> <A href='byond://?src=[REF(src)];tp=-1'>-</A> <A href='byond://?src=[REF(src)];tp=1'>+</A> <A href='byond://?src=[REF(src)];tp=30'>+</A>"
		var/temp = ""
