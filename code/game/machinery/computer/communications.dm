...
/obj/machinery/computer/communications/proc/get_call_shuttle_form(ai_interface = 0)
	...
	dat += "<BR>Are you sure you want to call the train? \[ <a href='byond://#' onclick='submit()'>Call</a> \]"
	return dat
...
/obj/machinery/computer/communications/proc/get_cancel_shuttle_form()
	...
	dat += "<BR>Are you sure you want to cancel the train? \[ <a href='byond://#' onclick='submit()'>Cancel</a> \]"
	return dat
