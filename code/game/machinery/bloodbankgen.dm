...
/obj/machinery/bloodbankgen/ui_interact(mob/user)
	...
	if(bag)
		...
		if(bag.reagents && bag.reagents.total_volume)
			dat += "<br><a href='byond://?src=\ref[src];activateinput=1'>Drain</a>"

		dat += "<br><a href='byond://?src=\ref[src];detachinput=1'>Detach</a>"
	...
	if(outbag)
		...
		if(!(outbag.reagents.total_volume >= outbag.reagents.maximum_volume))
			dat += "<br><a href='byond://?src=\ref[src];activateoutput=1'>Fill</a>"
		dat += "<br><a href='byond://?src=\ref[src];detachoutput=1'>Detach</a>"
